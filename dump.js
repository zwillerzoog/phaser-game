...
function preload() {    
    ...
    function create() {    
        ...
        for (var i = 0; i < 6; i++)    {        
            //  They are evenly spaced out on the X coordinate, 
            //with a random Y coordinate    	
            sprite = group.create(120 * i, 
                game.rnd.integerInRange(100, 400), 'seacreatures', 'octopus0000');    }   
                 //  These are the frame names for the octopus animation. 
                 //We use the generateFrames function to help create the array.    
                 ...
                 //  Here we just say 'play the swim animation', this time the 'play' method exists on the child itself, 
                 //so we can set the context to null.    
                 group.callAll('play', null, 'swim');    game.add.sprite(0, 466, 'coral');}
